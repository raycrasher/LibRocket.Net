...
KeyboardEventArgs::KeyboardEventArgs(RocketEvent *evt) : ElementEventArgs(evt)
{
	...
	ControlKeyPressed=eventPtr->GetParameter<int>("ctrl_key",0);
...
#define ELEMENT_ADD_HANDLER_DEFINITION(Handler, Args)   \
void Handler::ProcessEvent(RocketEvent &evt) { \
	EventHandler<Args^>^ h = Handlers; \
	(*h)(Element::Create(evt.GetCurrentElement()), gcnew Args(&evt));  \
}     

ELEMENT_ADD_HANDLER_DEFINITION(ElementEventHandler,ElementEventArgs);
ELEMENT_ADD_HANDLER_DEFINITION(KeyboardEventHandler,KeyboardEventArgs);
ELEMENT_ADD_HANDLER_DEFINITION(TextInputEventHandler,TextInputEventArgs);
ELEMENT_ADD_HANDLER_DEFINITION(MouseEventHandler,MouseEventArgs);
ELEMENT_ADD_HANDLER_DEFINITION(DragEventHandler,DragEventArgs);
ELEMENT_ADD_HANDLER_DEFINITION(FormSubmitEventHandler,FormSubmitEventArgs);
ELEMENT_ADD_HANDLER_DEFINITION(FormControlChangeEventHandler,FormControlChangeEventArgs);
ELEMENT_ADD_HANDLER_DEFINITION(HandleEventHandler,HandleEventArgs);
ELEMENT_ADD_HANDLER_DEFINITION(DataGridAddColumnEventHandler,DataGridAddColumnEventArgs);
ELEMENT_ADD_HANDLER_DEFINITION(DataGridRowEventHandler,DataGridRowEventArgs);
ELEMENT_ADD_HANDLER_DEFINITION(TabChangeEventHandler,TabChangeEventArgs);
